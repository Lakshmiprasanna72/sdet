...
select salesman_id,salesman_city from salesman5;
...
select * from salesman5 where salesman_city = 'Paris';
...
select salesman_id,commission from salesman5 where salesman_name = 'Paul Adam';

select * from salesman5;

select * from salesman5;

alter table salesman5 add grade int;
...
update salesman5 set grade = 100;
...
update table salesman5 grade = 200 where salesman_city='Paris';

select * from salesman5;

update salesman5 grade = 200 where salesman_city='Paris';

select * from salesman5;

update salesman5 set grade = 200 where salesman_city='Paris';
...
update salesman5 set grade = 300 where salesman_name = 'Paul Adam';

update salesman5 set salesman_name = 'Pierre' where salesman_name = 'McLyon';
